...
def checkCtdFileName(ctd=None, confile='.xmlcon'):
    ...
    file_path = Tkinter.filedialog.askopenfilename(title="Open file", initialdir="C:\\ctdSBE19\\temp",
...
#        file_path = file_path.replace('/','\\')
    ...
    file_path_xmlcon = Tkinter.filedialog.askopenfilename(title="Open file",
        initialdir="C:\\ctdSBE19\\ctd_config\\SBE\\XMLCON\\SBE19", filetypes=[("xmlcon",".xmlcon")])
