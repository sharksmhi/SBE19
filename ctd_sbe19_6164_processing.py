    ...
    def copy_files_to_server(self):
        ...
        if self.cnty == '77' and (self.ship == '10' or self.ship == 'SE'):
            ...
            if 0:
                ...
                server_data_dir = '\\\\scifi01.svea.slu.se\\Processed$\\McSeabirdChem\\20' + self.year + '\\cnv\\'
                #server_data_dir = '\\\\scifi01\\scifi\\Processed\\mcseabirdchem\\data\\'            
                server_plot_dir = '\\\\scifi01.svea.slu.se\\Processed$\\McSeabirdChem\\20' + self.year + '\\plots\\'
                #server_plot_dir = '\\\\scifi01\\scifi\\Processed\\mcseabirdchem\\plots\\'
                server_raw_dir = '\\\\scifi01.svea.slu.se\\Processed$\\McSeabirdChem\\20' + self.year + '\\raw\\'
